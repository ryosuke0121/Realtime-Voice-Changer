...
export const DEFAULT_PRESETS: Preset[] = [
    ...
    { id: 'robot', name: 'ロボット', pitch: 0, reverb: 0.3, distortion: 0.4, gain: 0.15, description: '機械的な音声' },
    { id: 'cave', name: '洞窟', pitch: -2, reverb: 0.8, distortion: 0, gain: 0.1, description: '広い空間の響き' },
    { id: 'monster', name: 'モンスター', pitch: -8, reverb: 0.5, distortion: 0.3, gain: 0.2, description: '低音で怪物のような声' },
];
